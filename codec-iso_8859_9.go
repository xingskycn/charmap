...
type codecISO_8859_9 struct {
	EncodeMap map[rune]byte
	DecodeMap map[byte]rune
}

func (c codecISO_8859_9) Encode(s string) (string, error) {
	return mapRunesToBytes(c.EncodeMap, s)
}

func (c codecISO_8859_9) Decode(s string) (string, error) {
